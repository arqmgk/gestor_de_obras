  ...
  const handleSubmit = async () => {
    ...
    try {
      const res = modo === "login"
        ...
        : await register({ nombre: form.nombre, email: form.email, password: form.password, empresa: form.empresa });
      ...
      <div style={box}>
        ...
        <div style={tabRow}>
          <button onClick={() => { setModo("login"); setError(null); }}
            style={{ ...tab, ...(modo === "login" ? tabActive : {}) }}>
            Ingresar
          </button>
          <button onClick={() => { setModo("register"); setError(null); }}
            style={{ ...tab, ...(modo === "register" ? tabActive : {}) }}>
            Registrarse
          </button>
        </div>
...
const box = {
  ...
  padding: "36px 32px", width: "100%", maxWidth: "380px", display: "flex", flexDirection: "column",
};
const logo = {
  color: "#e0e0e0", fontSize: "18px", fontWeight: "700", margin: "0 0 28px",
...
const tab = {
  ...
  padding: "7px", borderRadius: "4px", fontSize: "13px", fontWeight: "500",
};
...
const iS = {
  ...
  color: "#e0e0e0", padding: "9px 12px", fontSize: "13px", marginBottom: "14px",
  width: "100%", boxSizing: "border-box", display: "block",
};
const btnSubmit = {
  background: "#2563eb", border: "none", borderRadius: "4px", color: "#fff",
  cursor: "pointer", padding: "10px", fontWeight: "700", fontSize: "14px",
